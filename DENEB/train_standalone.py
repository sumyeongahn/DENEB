...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', help='Preset directory', default='./log/result/')
    ...
    args.preset_dir = f'{curr_dir}/{args.log_dir}/{args.dataset_logdir}/{args.alg}/{args.nratio}_{args.bratio}/preset/'
    args.end_log_dir = f'{curr_dir}/{args.result_dir}/{args.dataset_logdir}/{args.alg}/{args.nratio}_{args.bratio}/'
    
    df = pd.read_csv(args.preset_dir+'conf_clean.log' if args.clean_valid else args.preset_dir+'conf.log', index_col=0)
