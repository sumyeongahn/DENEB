...
def pretrained_ResNet18(num_classes):
    return Pretrained_ResNet18(num_classes)

def pretrained_ResNet34(num_classes):
    return Pretrained_ResNet101(num_classes)

def pretrained_ResNet50(num_classes):
    return Pretrained_ResNet101(num_classes)

def pretrained_ResNet101(num_classes):
    return Pretrained_ResNet101(num_classes)
...
class Pretrained_ResNet18(nn.Module):
    def __init__(self,num_classes):
        ...
        insize = model.fc.in_features
        self.model = nn.Sequential(*list(model.children())[:-1]) 
        self.fc = nn.Linear(insize, num_classes)
...
class Pretrained_ResNet34(nn.Module):
    def __init__(self,num_classes):
        super(Pretrained_ResNet34, self).__init__()        
...
class Pretrained_ResNet101(nn.Module):
    def __init__(self,num_classes):
        super(Pretrained_ResNet101, self).__init__()        
